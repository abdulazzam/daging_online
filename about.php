    ...
    >
      <div class="container">
        <a href="index.php" class="navbar-brand" title="home">
          <img src="assets/images/logoayam1.png" class="w-50" alt="logo" />
        </a>
        <button
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h1 class="" style="font-size: 60px;">Chicken Farm</h1>
              <h5 class="">Toko Daging Ayam Potong Segar Online</h5>
              <a
                  href="https://wa.me/62895331354632"
                  target="_blank"
      ...
      <section class="store-adventeges" id="adventeges">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <h2 class="font-weight-bold mb-2">PT. Chicken Farm</h2>   
              <hr style="border-top: 5px solid black; width: 80px;">
            </div>
          </div>
          <div class="row text-center">
            <div class="col-md-12">
              <p>PT. Chicken Farm merupakan perusahaan yang bergerak di dalam bidang pemotongan hewan ayam dan perdagangan ayam potong, PT. Chicken Farm berkantor di Ratujaya, Depok pada saat ini PT. Chicken Farm fokus melakukan perdagangan/suplay ayam potong kebeberapa perusahaan industri pengolahan ayam, juga rutin mengisi beberapa pedagang pasar di area Jabodetabek </p>
            </div>
          </div>
