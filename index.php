      ...
      <section class="store-landing">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            <div class="col-md-5">
              <img src="assets/images/ayam.jpg" class="w-100" alt="" />
            </div>
            <div class="col-md-6">
              ...
              <p class="store-subtitle-landing" style="line-height: 28px; color: rgb(146, 146, 146);">
                Chicken Farm adalah toko daging yang menjual daging Ayam segar,
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        ...
                        <div class="subtitle-text">
                          Pengiriman cepat langsung ke tempat
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        ...
                        <div class="subtitle-text">
                          Pengalaman belanja online yang lebih memuaskan
                        </div>
                      </div>
                    </div>
                  </div>
